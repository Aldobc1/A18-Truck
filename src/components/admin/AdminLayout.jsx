...
const { FiTruck, FiSettings, FiMapPin, FiFileText, FiLogOut, FiHome, FiFolder, FiMenu, FiX, FiBriefcase, FiUser, FiChevronDown, FiGrid, FiMonitor, FiShield, FiActivity, FiCreditCard, FiUsers } = FiIcons;
...
const AdminLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Usuarios', href: '/admin/workspaces', icon: FiUsers, roles: ['admin', 'superadmin'] },
    { name: 'Mi Perfil', href: '/admin/profile', icon: FiUser, roles: ['admin', 'superadmin', 'supervisor'] },
    { name: 'Facturación', href: '/admin/billing', icon: FiCreditCard, roles: ['admin', 'superadmin'] },
  ];
              ...
              {dashboardDropdownOpen && (
                <div className="absolute z-10 mt-1 w-full bg-white rounded-md shadow-lg border border-gray-200 py-1">
                  {availableDashboards.map((dashboard) => (
                    ...
                    >
                      <SafeIcon icon={dashboard.icon} className={`w-4 h-4 ${
