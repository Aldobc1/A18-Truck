          ...
          <div className="absolute bottom-0 w-64 p-5 border-t border-gray-200">
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-3 mb-4 w-full hover:bg-gray-50 p-2 rounded-lg transition-colors"
              >
              ...
              {/* User Dropdown */}
              {userDropdownOpen && (
                <div className="absolute bottom-full mb-2 w-full bg-white rounded-md shadow-lg border border-gray-200 py-1">
                  <Link
                    to="/admin/profile"
                    className="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center space-x-2"
                    onClick={() => setUserDropdownOpen(false)}
                  >
                    <SafeIcon icon={FiUserCheck} className="w-4 h-4 text-gray-400" />
                    <span>Mi Perfil</span>
                  </Link>
                  <Link
                    to="/admin/billing"
                    ...
                    onClick={() => setUserDropdownOpen(false)}
                  >
                    <SafeIcon icon={FiCreditCard} className="w-4 h-4 text-gray-400" />
              ...
              >
                ...
                <div className="p-4 border-b border-gray-200">
                  ...
                  <div className="space-y-1">
                    <Link
                      to="/admin/profile"
                      className="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center space-x-2 rounded-lg"
                      onClick={closeSidebar}
                    >
                      <SafeIcon icon={FiUserCheck} className="w-4 h-4 text-gray-400" />
                      <span>Mi Perfil</span>
