...
function AppContent() {
  ...
  const getRedirectPath=()=> {
    ...
    switch (user.role) {
      ...
      case 'supervisor': return '/admin';// Por ahora redirigimos a admin,podríamos tener un dashboard específico 
  ...
  return ( 
    <AnimatePresence mode="wait"> 
      <Routes> 
        ...
        <Route path="/superadmin/*" element={user && user.role==='superadmin' ? ( 
          <SuperAdminDashboard /> 
        ) : ( 
